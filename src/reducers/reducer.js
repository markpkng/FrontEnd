...
export const reducer = (state = initialState, action) => {
    switch(action.type){
        ...
        case t.STORE_RIDER_SUCCESS: return {...state, loading: false, error: '', user: action.payload, reload: false}
        case t.STORE_RIDER_FAIL: return {...state, loading: false, reload: false}
        case t.REGISTER_SUCCESS: return {...state, loading: false, error: '', registerModal: true, reload: false}
        case t.REGISTER_FAIL: return {...state, loading: false, error: action.payload, reload: false}
        case t.GET_DRIVERS_SUCCESS: return {...state, loading: false, error: '', reload: false}
        case t.GET_DRIVERS_FAIL: return {...state, loading: false, error: action.payload, reload: false}
        case t.GET_DRIVER_SUCCESS: return {...state, loading: false, error: '', reload: false}
        ...
        case t.GET_RIDER_SUCCESS: return {...state, loading: false, error: '', reload: false}
        ...
        case t.UPDATE_PROFILE_IMAGE_FAIL: return {...state, loading: false, reload: false}
        case t.NOTIFY_DRIVER_SUCCESS: return {...state, loading: false, reload: false}
        case t.NOTIFY_DRIVER_FAIL: return {...state, loading: false, reload: false}
        case t.SHOULD_RELOAD: return {...state, reload: true}
        case t.STOP_RELOAD: return {...state, reload: false}
        default: return {
            ...state
        }
    }
