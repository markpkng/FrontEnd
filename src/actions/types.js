...
export const NOTIFY_DRIVER_SUCCESS = 'NOTIFY_DRIVER_SUCCESS';
export const NOTIFY_DRIVER_FAIL = 'NOTIFY_DRIVER_FAIL';
...
export const STORE_RIDER_SUCCESS = 'STORE_RIDER_SUCCESS';
export const STORE_RIDER_FAIL = 'STORE_RIDER_FAIL';

//profile image
export const UPDATE_PROFILE_IMAGE_SUCCESS = 'UPLOAD_IMAGE_SUCCESS';
export const UPDATE_PROFILE_IMAGE_FAIL = 'UPLOAD_IMAGE_FAIL';
